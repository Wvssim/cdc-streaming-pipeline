...
#   .\infra\run-services.ps1                  # demarre les 6 services (fenetres minimisees)
...
Write-Host ""
Write-Host "6 services lances (fenetres minimisees). Verifier : curl http://localhost:8081/api/documents (401 attendu sans token = up)."
